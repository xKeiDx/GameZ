...
function preload() {
  try {
    ...
    hurtSound = loadSound('sounds/DeathByEnemy.wav');
	killSound = loadSound('sounds/EnemyDeath.wav');
    bgMusic = loadSound('sounds/backgroundMusic.wav'); // Загрузка фоновой музыки
...
function drawPlatforms() {
  ...
  fill(139, 69, 19); // Коричневый цвет для платформ
  for (let platform of platforms) {
